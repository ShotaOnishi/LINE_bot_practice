...
Menu.create(:name => '天丼', :picture => 'https://res.cloudinary.com/hmfnscv52/image/upload/v1477837316/cqv23xsye53hb8inlgz6.png', :detail => 'あ', :category => '丼', :price => 800)
Menu.create(:name => 'カレー', :picture => 'https://res.cloudinary.com/hmfnscv52/image/upload/v1477837346/eehwvt2exfnfleqhi4vi.png', :detail => 'あ', :category => '丼', :price => 700)
Menu.create(:name => 'ラーメン', :picture => 'https://res.cloudinary.com/hmfnscv52/image/upload/v1477837372/d3fhvkxboxaujs4fatvw.png', :detail => 'あ', :category => '麺類', :price => 650)
